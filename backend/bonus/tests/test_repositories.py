...
class BonusTestCase(TestCase):
    ...
    def test_get_active_bonuses_end_bonus(self):
        Bonus.objects.create(bonus_name='тестовый бонус1', limit=True, amount_bonus=0)
        result = self.bonus.get_active_bonuses()
        test_data = Bonus.objects.none()
        self.assertQuerysetEqual(test_data, result)

    def test_get_active_bonuses_unlimited(self):
        Bonus.objects.create(bonus_name='тестовый бонус1', limit=False)
        result = self.bonus.get_active_bonuses()
        test_data = Bonus.objects.all()
        self.assertQuerysetEqual(test_data, result)

    def test_get_active_bonuses_limited(self):
        Bonus.objects.create(bonus_name='тестовый бонус1', limit=True, amount_bonus=1)
        result = self.bonus.get_active_bonuses()
        test_data = Bonus.objects.all()
        self.assertQuerysetEqual(test_data, result)
    ...
    def test_get_active_bonuses_bonus_list(self):
        Bonus.objects.create(bonus_name='тестовый бонус1', limit=True, amount_bonus=1)
        Bonus.objects.create(bonus_name='тестовый бонус2', limit=False)
        result = self.bonus.get_active_bonuses()
        test_data = Bonus.objects.all()
        self.assertQuerysetEqual(test_data, result, ordered=False)

    def test_reduce_negative_number(self):
        bonus = Bonus.objects.create(bonus_name='тестовый бонус1', limit=True, amount_bonus=1)
    ...
    def test_reduce_unlimited(self):
        bonus = Bonus.objects.create(bonus_name='тестовый бонус1', limit=False)
    ...
    def test_reduce_limited(self):
        amount_reduce = 1
        bonus = Bonus.objects.create(bonus_name='тестовый бонус1', limit=True, amount_bonus=amount_reduce)
